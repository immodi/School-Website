                ...
                <div class="white-box">
                    <div class="row mb-30">
                        <div class="col-lg-12 ">
                            <select class="niceSelect w-100 bb user_type form-control{{ $errors->has('user_type') ? ' is-invalid' : '' }}" name="member_type">
                                <option data-display=" @lang('zoom::lang.member_type') *" value="">@lang('zoom::lang.member_type') *</option>
                    ...
                    <div class="row mt-40">
                        <div class="col-lg-12" id="selectTeacherDiv">
                            <label for="checkbox" class="mb-2">@lang('zoom::lang.member') *</label>
                        ...
                        <div class="row mt-40">
                            <div class="col-lg-6">
                                <label>@lang('zoom::lang.date_of_meeting')<span>*</span></label>
                            ...
                            <div class="col-lg-6">
                                    <label>@lang('zoom::lang.time_of_meeting')<span>*</span></label>
                        ...
                        <div class="row mt-40">
                            <div class="col-lg-12">
                                <div class="input-effect">
                                    ...
                                    <label>@lang('zoom::lang.meeting_durration')<span>*</span></label>
                                    <span class="focus-border"></span>
                        ...
                        <div class="row mt-40">
                            <div class="col-lg-12">
                                <div class="input-effect">
                                    ...
                                    <label>@lang('zoom::lang.meeting') @lang('zoom::lang.start') @lang('zoom::lang.before')</label>
                                    <span class="focus-border"></span>
