 ...
 @endif
    ...
    <div class="main-title">
        <h3 class="mb-0">
            @lang('zoom::lang.meeting')   @lang('zoom::lang.list')
        </h3>
    </div>
                    ...
                    <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href="{{ route('zoom.meetings.show', $meeting->meeting_id) }}">@lang('zoom::lang.view')</a>
                                    @if(userPermission(557))
                                        <a class="dropdown-item" href="{{ route('zoom.meetings.edit',$meeting->id ) }}">@lang('zoom::lang.edit')</a>
                                    @endif
                                    @if(Auth::user()->id == $meeting->created_by)
                                     ...
                                     <a class="dropdown-item modalLink" data-modal-size="modal-md" title="@lang('zoom::lang.upload') @lang('zoom::lang.recorded') @lang('zoom::lang.video')"  
                                           href="{{route('zoom.meeting-upload-vedio-file', [$meeting->id])}}" >@lang('zoom::lang.upload') @lang('zoom::lang.recorded') @lang('zoom::lang.video')</a>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title"> @lang('zoom::lang.upload') @lang('zoom::lang.recorded')  @lang('zoom::lang.file')</h4>
                                            ...
                                            <div class="row mt-25">
                                                <div class="col-lg-12">
                                                    <div class="input-effect">
                                                        ...
                                                        <label> @lang('zoom::lang.link')</label>
                                            ...
                                            <div class="row no-gutters input-right-icon">
                                                ...
                                                <div class="col-auto">
                                                    <button class="primary-btn-small-input" type="button">
                                                        <label class="primary-btn small fix-gr-bg" for="photo"> @lang('zoom::lang.browse')</label>
                                        ...
                                        <div class="col-lg-12 text-center mt-40">
                                            <div class="mt-40 d-flex justify-content-between">
                                                <button type="button" class="primary-btn tr-bg"
                                                        data-dismiss="modal">@lang('zoom::lang.cancel')
                                                </button>

                                                <button class="primary-btn fix-gr-bg submit" type="submit">@lang('zoom::lang.save')
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                ...
                @if(userPermission(558))
                    <div class="modal fade admin-query" id="d{{$meeting->id}}" >
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title">@lang('zoom::lang.delete_meetings')</h4>
                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                </div>
