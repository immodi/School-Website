...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('zoom::lang.meeting')  @lang('zoom::lang.details')</h1>
            <div class="bc-pages">
                <a href="{{route('dashboard')}}">@lang('zoom::lang.dashboard')</a>
                <a href="#">@lang('zoom::lang.meeting')</a>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <table id="" class="display school-table school-table-style" cellspacing="0" width="100%">
                            ...
                            @if(userPermission(559))
                                <tr>
                                    <td>{{ $sl++ }} </td> <td class="propertiesname">@lang('zoom::lang.join_url')</td> <td> <a href="{{@$results['join_url']}}" target="_blank" >Click</a></td>
                                </tr>
                            @endif
                            <tr>
                                <td>{{ $sl++ }} </td> <td class="propertiesname">h323 @lang('zoom::lang.password')</td> <td>{{@$results['h323_password']}}</td>
                            </tr>
