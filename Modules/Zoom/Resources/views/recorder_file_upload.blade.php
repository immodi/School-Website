        ...
        <div class="row">
                                ...
                                <div class="col-lg-12">
                                       <div class="input-effect">
                                            <input class="primary-input form-control" type="text" name="link" value="{{$meeting->vedio_link != "" ? $meeting->vedio_link :''}}">
                                                    <label class="paddinfTop"> @lang('zoom::lang.link')</label>
                        ...
                        <div class="col-auto">
                            <button class="primary-btn-small-input" type="button">
                                <label class="primary-btn small fix-gr-bg"
                                       for="browseFile">@lang('zoom::lang.browse')</label>
            ...
            <div class="col-lg-12 text-center mt-40">
                <div class="mt-40 d-flex justify-content-between">
                    ...
                    <button class="primary-btn fix-gr-bg submit" type="submit">@lang('zoom::lang.save')</button>
                </div>
            </div>
        </div>
    {{ Form::close() }}
