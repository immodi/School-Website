...
@section('title')
    @lang('zoom::lang.virtual_class') @lang('zoom::lang.reports')
@endsection
...
<section class="sms-breadcrumb mb-40 white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('zoom::lang.virtual_class') @lang('zoom::lang.reports') </h1>
            <div class="bc-pages">
                <a href="{{route('dashboard')}}">@lang('zoom::lang.dashboard')</a>
                <a href="#">@lang('zoom::lang.virtual_class')</a>
                <a href="#"> @lang('zoom::lang.reports') </a>
            </div>
        </div>
    </div>
</section>
                    ...
                    <form action="{{ route('zoom.virtual.class.reports.show') }}" method="GET">
                            <div class="row">
                                ...
                                @if(Auth::user()->role_id == 1)
                                    <div class="col-lg-2 mt-30-md">
                                        <select class="w-100 niceSelect bb form-control{{ $errors->has('section_id') ? ' is-invalid' : '' }}" name="teachser_ids">
                                            <option data-display="@lang('zoom::lang.select_teacher')" value="">@lang('zoom::lang.select_teacher')</option>
                                ...
                                <div class="col-lg-3 mt-30-md">
                                    <input data-display="@lang('zoom::lang.from_date')" placeholder="@lang('zoom::lang.from_date')" class="primary-input date form-control" type="text" name="from_time" value="{{ isset($from_time) ? Carbon\Carbon::parse($from_time)->format('m/d/Y') : '' }}">
                                </div>
                                <div class="col-lg-3 mt-30-md">
                                    <input data-display="@lang('zoom::lang.to_date')" placeholder="@lang('zoom::lang.to_date')" class="primary-input date form-control" type="text" name="to_time" value="{{ isset($to_time) ? Carbon\Carbon::parse($to_time)->format('m/d/Y') : '' }}">
                                </div>
                                @php
                                    $tooltip = "";
                        ...
                        <table id="default_table2" class="display school-table" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    @endif
                                    <th>@lang('zoom::lang.meeting_id')</th>
                                    <th>@lang('zoom::lang.password')</th>
                                    <th>@lang('zoom::lang.topic')</th>
                                    @if (Auth::user()->role_id == 1 || Auth::user()->role_id == 4)
                                        <th>@lang('zoom::lang.teachers')</th>
                                    @endif
