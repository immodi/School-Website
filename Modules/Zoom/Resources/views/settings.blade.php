...
@section('title') 
    @lang('zoom::lang.manage') @lang('zoom::lang.zoom') @lang('zoom::lang.settings')
@endsection
@section('mainContent')
 <style type="text/css">
...
<section class="sms-breadcrumb mb-40 up_breadcrumb white-box">
    <div class="container-fluid">
        <div class="row justify-content-between">
            <h1>@lang('zoom::lang.manage') @lang('zoom::lang.zoom_setting')</h1>
            <div class="bc-pages">
                <a href="{{route('dashboard')}}">@lang('zoom::lang.dashboard')</a>
                <a href="#">@lang('zoom::lang.virtual_class')</a>
                <a href="#">@lang('zoom::lang.settings')</a>
            </div>
        </div>
    </div>
</section>
                ...
                <div class="col-lg-12">
                    <form action="{{ route('zoom.settings.update') }}" method="POST">
                        ...
                        <div class="white-box">
                                <div class="row p-0">
                                    <div class="col-lg-12">
                                        <h3 class="text-center">@lang('zoom::lang.zoom_setting')</h3>
                                        <hr>
                                        ...
                                        <div class="row mb-40 mt-40">
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    <div class="col-lg-5 d-flex">
                                                        <p class="text-uppercase fw-500 mb-10">@lang('zoom::lang.meeting_approval')</p>
                                                    </div>
                                                    <div class="col-lg-7">
                                                        <select class="w-100 bb niceSelect form-control {{ @$errors->has('approval_type') ? ' is-invalid' : '' }}" name="approval_type">
                                                            <option data-display="@lang('zoom::lang.select') *" value="">@lang('zoom::lang.select') *</option>
                                                            <option value="0" {{ old('approval_type',$setting->approval_type) == 0? 'selected' : ''}} >@lang('zoom::lang.automatically') </option>
                                                            <option value="1" {{ old('approval_type',$setting->approval_type) == 1? 'selected' : ''}} >@lang('zoom::lang.manually') @lang('zoom::lang.approve')</option>
                                                            <option value="2" {{ old('approval_type',$setting->approval_type) == 2? 'selected' : ''}} >@lang('zoom::lang.no') @lang('zoom::lang.registration') @lang('zoom::lang.required')</option>
                                                        </select>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    <div class="col-lg-5 d-flex">
                                                        <p class="text-uppercase fw-500 mb-10">@lang('zoom::lang.host_video') </p>
                                                    </div>
                                                    <div class="col-lg-7">
                                                            <div class="radio-btn-flex ml-20">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="">
                                                                        ...
                                                                        <label for="host_video_on">@lang('zoom::lang.enable')</label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <div class="">
                                                                        ...
                                                                        <label for="host_video">@lang('zoom::lang.disable')</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="row mb-40 mt-40">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    <div class="col-lg-5 d-flex">
                                                        <p class="text-uppercase fw-500 mb-10"> @lang('zoom::lang.auto_recording') ( @lang('zoom::lang.for_paid_package') )</p>
                                                    </div>
                                                    <div class="col-lg-7">
                                                        <select class="w-100 bb niceSelect form-control {{ @$errors->has('auto_recording') ? ' is-invalid' : '' }}" name="auto_recording">
                                                            <option data-display="@lang('zoom::lang.select') *" value="">@lang('zoom::lang.select') *</option>
                                                            <option value="none" {{ old('auto_recording',$setting->auto_recording) == 'none'? 'selected' : ''}} >@lang('zoom::lang.none')</option>
                                                            <option value="local" {{ old('auto_recording',$setting->auto_recording) == 'local'? 'selected' : ''}} >@lang('zoom::lang.local')</option>
                                                            <option value="cloud" {{ old('auto_recording',$setting->auto_recording) == 'cloud'? 'selected' : ''}} >@lang('zoom::lang.cloud')</option>
                                                        </select>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    <div class="col-lg-5 d-flex">
                                                        <p class="text-uppercase fw-500 mb-10">@lang('zoom::lang.participant_video') </p>
                                                    </div>
                                                    <div class="col-lg-7">
                                                            <div class="radio-btn-flex ml-20">
                                                                <div class="row">
                                                                <div class="col-lg-6">
                                                                    <div class="">
                                                                        ...
                                                                        <label for="participant_video_on">@lang('zoom::lang.enable')</label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <div class="">
                                                                        ...
                                                                        <label for="participant_video">@lang('zoom::lang.disable')</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="row mb-40 mt-40">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    <div class="col-lg-5 d-flex">
                                                        <p class="text-uppercase fw-500 mb-10">@lang('zoom::lang.audio_options')</p>
                                                    </div>
                                                    <div class="col-lg-7">
                                                        <select class="w-100 bb niceSelect form-control {{ @$errors->has('audio') ? ' is-invalid' : '' }}" name="audio">
                                                            <option data-display="@lang('zoom::lang.select') *" value="">@lang('zoom::lang.select') *</option>
                                                            <option value="both" {{ old('audio',$setting->audio) == 'both' ? 'selected' : ''}} >@lang('zoom::lang.both')</option>
                                                            <option value="telephony"  {{ old('audio',$setting->audio) == 'telephony'? 'selected' : ''}}>@lang('zoom::lang.telephony')</option>
                                                            <option value="voip"  {{ old('audio',$setting->audio) == 'voip'? 'selected' : ''}} >@lang('zoom::lang.voip')</option>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    <div class="col-lg-5 d-flex">
                                                        <p class="text-uppercase fw-500 mb-10">@lang('zoom::lang.join_before_host') </p>
                                                    </div>
                                                    <div class="col-lg-7">
                                                            <div class=" radio-btn-flex ml-20">
                                                                <div class="row">
                                                                <div class="col-lg-6">
                                                                    <div class="">
                                                                        ...
                                                                        <label for="join_before_host_on">@lang('zoom::lang.enable')</label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <div class="">
                                                                        ...
                                                                        <label for="join_before_host">@lang('zoom::lang.disable')</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="row mb-40 mt-40">
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    <div class="col-lg-5 d-flex">
                                                        <p class="text-uppercase fw-500 mb-10">@lang('zoom::lang.pakage')</p>
                                                    </div>
                                                    <div class="col-lg-7">
                                                        <select class="w-100 bb niceSelect form-control {{ @$errors->has('package_id') ? ' is-invalid' : '' }}" name="package_id">
                                                            <option data-display="@lang('zoom::lang.select') *" value="">@lang('zoom::lang.select') *</option>
                                                            <option value="1" {{ old('package_id',$setting->package_id) == 1 ? 'selected' : ''}} >@lang('zoom::lang.basic') (@lang('zoom::lang.free'))</option>
                                                            <option value="2" {{ old('package_id',$setting->package_id) == 2 ? 'selected' : ''}} >@lang('zoom::lang.pro')</option>
                                                            <option value="3" {{ old('package_id',$setting->package_id) == 3 ? 'selected' : ''}} >@lang('zoom::lang.business')</option>
                                                            <option value="4" {{ old('package_id',$setting->package_id) == 4 ? 'selected' : ''}} >@lang('zoom::lang.enterprise')</option>
                                                        </select>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    <div class="col-lg-5 d-flex">
                                                        <p class="text-uppercase fw-500 mb-10">@lang('zoom::lang.waiting_room')</p>
                                                    </div>
                                                    <div class="col-lg-7">
                                                            <div class=" radio-btn-flex ml-20">
                                                                <div class="row">
                                                                <div class="col-lg-6">
                                                                    <div class="">
                                                                        ...
                                                                        <label for="waiting_room_on">@lang('zoom::lang.enable')</label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <div class="">
                                                                        ...
                                                                        <label for="waiting_room">@lang('zoom::lang.disable')</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="row mb-40 mt-40">
                                            <div class="col-lg-6">
                                                <div class="input-effect sm2_mb_20 md_mb_20">
                                                    ...
                                                    <label>@lang('zoom::lang.api_key')<span>*</span> </label>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    <div class="col-lg-5 d-flex">
                                                        <p class="text-uppercase fw-500 mb-10"> @lang('zoom::lang.mute_upon_entry') </p>
                                                    </div>
                                                    <div class="col-lg-7">
                                                            ...
                                                            <div class="radio-btn-flex ml-20">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="">
                                                                        ...
                                                                        <label for="mute_upon_entr_on">@lang('zoom::lang.enable')</label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <div class="">
                                                                        ...
                                                                        <label for="mute_upon_entry">@lang('zoom::lang.disable')</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="row mb-40 mt-40">
                                            <div class="col-lg-6">
                                                <div class="input-effect sm2_mb_20 md_mb_20">
                                                    ...
                                                    <label>@lang('zoom::lang.serect_key')<span>*</span></label>
                                                    <span class="focus-border"></span>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    <div class="col-lg-5 d-flex">
                                                        <p class="text-uppercase fw-500 mb-10">@lang('zoom::lang.api') use for</p>
                                                    </div>
                                                    <div class="col-lg-7">
                                                          <p class="slider_zoom">@lang('zoom::lang.admin')/@lang('zoom::lang.teacher')</p>
                                                            <div class=" radio-btn-flex ml-20">
                                                                ...
                                                                {{-- <div class="col-lg-6">
                                                                    <div class="">
                                                                        ...
                                                                        <label for="admin_api">@lang('zoom::lang.admin')</label>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <div class="">
                                                                        ...
                                                                        <label for="teahcer_api">@lang('zoom::lang.teacher')</label>
                                                                    </div>
                                                                </div> --}}
