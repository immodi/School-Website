                ...
                <div class="white-box">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <select class="w-100 bb niceSelect form-control {{ @$errors->has('class') ? ' is-invalid' : '' }}" id="select_class" name="class">
                                    <option data-display="@lang('zoom::lang.select_class') *" value="">@lang('zoom::lang.select_class') *</option>
                        ...
                        <div class="row  mt-40">
                            ...
                            {{-- <div class="col-lg-12" id="selectSectionsDiv">
                                <label for="checkbox" class="mb-2">@lang('zoom::lang.section')</label>
                               ...
                               <div class="">
                                   ...
                                   <label for="checkbox_section" class="mt-3">@lang('zoom::lang.select_all')</label>
                               </div>
                            ...
                            <div class="col-lg-12" id="select_section_div">                                
                                <select class="w-100 bb niceSelect form-control {{ @$errors->has('section') ? ' is-invalid' : '' }}" id="select_section" name="section">
                                    <option data-display="@lang('zoom::lang.select_section')" value="">@lang('zoom::lang.select_section') </option>
                                    @if(isset($editdata))
                        ...
                        <div class="row mt-40">
                            <div class="col-lg-12" id="selectTeacherDiv">
                                <label for="teacher_ids" class="mb-2">@lang('zoom::lang.teacher') *</label>
                        ...
                        <div class="row mt-40">
                            <div class="col-lg-12">
                                <div class="input-effect">
                                    ...
                                    <label>@lang('zoom::lang.topic')<span>*</span></label>
                        ...
                        <div class="row mt-40">
                            <div class="col-lg-12">
                                ...
                                <textarea class="primary-input form-control" cols="0" rows="4" name="description" id="address">{{isset($editdata) ? old('description',$editdata->description) : old('description')}}</textarea>
                                    <label>@lang('zoom::lang.description')</label>
                        ...
                        <div class="row mt-40">
                            <div class="col-lg-6">
                                <label>@lang('zoom::lang.date_of_class')<span>*</span></label>
                            ...
                            <div class="col-lg-6">
                                    <label>@lang('zoom::lang.time_of_class')<span>*</span></label>
                        ...
                        <div class="row mt-40">
                            <div class="col-lg-12">
                                <div class="input-effect">
                                    ...
                                    <label>@lang('zoom::lang.duration_of_class')<span>*</span></label>
                                    <span class="focus-border"></span>
                        ...
                        <div class="row mt-40">
                            <div class="col-lg-12">
                                <div class="input-effect">
                                    ...
                                    <label>@lang('zoom::lang.class') @lang('zoom::lang.start') @lang('zoom::lang.before')</label>
                                    <span class="focus-border"></span>
                        ...
                        <div class="row mt-40">
                            <div class="col-lg-12">
                                <div class="input-effect">
                                    ...
                                    <label>@lang('zoom::lang.password')<span>*</span></label>
                                    <span class="focus-border"></span>
                    ...
                    <div class="row mt-30">
                        <div class="col-lg-12 d-flex">
                            <p class="text-uppercase fw-500 mb-10" style="width: 130px;">@lang('zoom::lang.zoom_recurring')</p>
                            <div class="d-flex radio-btn-flex ml-40">
                                @if (isset($editdata))
                                    ...
                                    <label for="recurring_options1">@lang('zoom::lang.yes')</label>
                                    </div>
                                    <div class="mr-30">
                                        ...
                                        <label for="recurring_options2">@lang('zoom::lang.no')</label>
                                    </div>
                                @else
                                    <div class="mr-30">
                    ...
                    <div class="row mt-20 recurrence-section-hide">
                        <div class="col-lg-6">
                            ...
                            <select class="w-100 bb niceSelect form-control {{ @$errors->has('recurring_type') ? ' is-invalid' : '' }}" id="recurring_type" name="recurring_type">
                                <option data-display="@lang('zoom::lang.type') *" value="">@lang('zoom::lang.type') *</option>
                                @if (isset($editdata))
                                    <option value="1" {{ old('recurring_type',$editdata->recurring_type) == 1  ? 'selected':''}} >@lang('zoom::lang.zoom_recurring_daily')</option>
                                    <option value="2" {{ old('recurring_type',$editdata->recurring_type) == 2  ? 'selected':''}} >@lang('zoom::lang.zoom_recurring_weekly')</option>
                                    <option value="3" {{ old('recurring_type',$editdata->recurring_type) == 3  ? 'selected':''}}>@lang('zoom::lang.zoom_recurring_monthly') </option>
                                @else
                                    <option value="1" {{ old('recurring_type') == 1  ? 'selected':''}} > @lang('zoom::lang.zoom_recurring_daily')</option>
                                    <option value="2" {{ old('recurring_type') == 2  ? 'selected':''}} > @lang('zoom::lang.zoom_recurring_weekly')</option>
                                    <option value="3" {{ old('recurring_type') == 3  ? 'selected':''}}>  @lang('zoom::lang.zoom_recurring_monthly') </option>
                                @endif
                            </select>
                        ...
                        <div class="col-lg-6">
                                ...
                                <select class="w-100 bb niceSelect form-control {{ @$errors->has('recurring_repect_day') ? ' is-invalid' : '' }}" id="recurring_repect_day" name="recurring_repect_day">
                                        <option data-display="@lang('zoom::lang.select') *" value="">@lang('zoom::lang.zoom_recurring_repect') *</option>
                                    @for ($i = 1; $i <= 15; $i++)
                                        @if (isset($editdata))
                    ...
                    {{-- <div class="row mt-30 day_hide" id="day_hide">
                        <div class="col-lg-12">
                            <label>@lang('zoom::lang.occurs_on') *</label>
                            @foreach($days as $day)
                                        <div class="row">
                                            <div class="col-md-4">
                                                @if(isset($editdata))
                    ...
                    <div class="row mt-30 recurrence-section-hide">
                        <div class="col-lg-6">
                            <label>@lang('zoom::lang.zoom_recurring_end') *</label>
                        ...
                        <div class="col-auto">
                            <button class="primary-btn-small-input" type="button">
                                <label class="primary-btn small fix-gr-bg"
                                    for="upload_content_file">@lang('zoom::lang.browse')</label>
                    ...
                    <div class="row mt-40">
                        <div class="col-lg-12 d-flex">
                            <p class="text-uppercase fw-500 mb-10" style="width: 130px;">@lang('zoom::lang.change_default_settings')</p>
                            <div class="d-flex radio-btn-flex ml-40">
                                    <div class="mr-30 row">
                                        ...
                                        <label for="change_default_settings">@lang('zoom::lang.yes')</label>
                                    </div>
                                    <div class="mr-30 row">
                                        ...
                                        <label for="change_default_settings2">@lang('zoom::lang.no')</label>
                                    </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mt-40 default-settings">
                        <div class="col-lg-12 d-flex">
                            <p class="text-uppercase fw-500 mb-10" style="width: 130px;">@lang('zoom::lang.join_before_host')</p>
                            <div class="d-flex radio-btn-flex ml-40">
                                @if (isset($editdata))
                                    <div class="mr-30 row">
                                        ...
                                        <label for="metting_options1">@lang('zoom::lang.yes')</label>
                                    </div>
                                    <div class="mr-30 row">
                                        ...
                                        <label for="metting_options2">@lang('zoom::lang.no')</label>
                                    </div>
                                @else
                                    <div class="mr-30 row">
                    ...
                    <div class="row mt-30 default-settings">
                        <div class="col-lg-12 d-flex">
                            <p class="text-uppercase fw-500 mb-10" style="width: 130px;">@lang('zoom::lang.host_video')</p>
                            <div class="d-flex radio-btn-flex ml-40">
                                @if (isset($editdata))
                                    <div class="mr-30 row">
                                        ...
                                        <label for="host_video1">@lang('zoom::lang.yes')</label>
                                    </div>
                                    <div class="mr-30 row">
                                        ...
                                        <label for="host_video2">@lang('zoom::lang.no')</label>
                                    </div>
                                @else
                                    <div class="mr-30 row">
                    ...
                    <div class="row mt-30 default-settings">
                        <div class="col-lg-12 d-flex">
                            <p class="text-uppercase fw-500 mb-10" style="width: 130px;">@lang('zoom::lang.participant_video')</p>
                            <div class="d-flex radio-btn-flex ml-40">
                                @if (isset($editdata))
                                    <div class="mr-30 row">
                                        ...
                                        <label for="host_video3">@lang('zoom::lang.yes')</label>
                                    </div>
                                    <div class="mr-30 row">
                                        ...
                                        <label for="host_video4">@lang('zoom::lang.no')</label>
                                    </div>
                                @else
                                    <div class="mr-30 row">
                    ...
                    <div class="row mt-30 default-settings">
                        <div class="col-lg-12 d-flex">
                            <p class="text-uppercase fw-500 mb-10" style="width: 130px;">@lang('zoom::lang.mute_upon_entry') </p>
                            <div class="d-flex radio-btn-flex ml-40">
                                @if (isset($editdata))
                                    <div class="mr-30 row">
                                        ...
                                        <label for="mute_upon_entry_on">@lang('zoom::lang.yes')</label>
                                    </div>
                                    <div class="mr-30 row">
                                        ...
                                        <label for="mute_upon_entry">@lang('zoom::lang.no')</label>
                                    </div>
                                @else
                                    <div class="mr-30 row">
                    ...
                    <div class="row mt-30 default-settings">
                        <div class="col-lg-12 d-flex">
                            <p class="text-uppercase fw-500 mb-10" style="width: 130px;">@lang('zoom::lang.waiting_room')</p>
                            <div class="d-flex radio-btn-flex ml-40">
                                @if (isset($editdata))
                                    <div class="mr-30 row">
                                        ...
                                        <label for="waiting_room_on">@lang('zoom::lang.yes')</label>
                                    </div>
                                    <div class="mr-30 row">
                                        ...
                                        <label for="waiting_room">@lang('zoom::lang.no')</label>
                                    </div>
                                @else
                                    <div class="mr-30 row">
                    ...
                    @if ($default_settings->package_id != 1 )
                        <div class="row mt-30 default-settings">
                            <div class="col-lg-12 row">
                                <p class="text-uppercase fw-500 mb-10 col-lg-6" style="width: 130px;">@lang('zoom::lang.auto_recording')</p>
                                <div class="col-lg-6">
                                    <select class="w-100 bb niceSelect form-control {{ @$errors->has('auto_recording') ? ' is-invalid' : '' }}" name="auto_recording">
                                        @if (isset($editdata))
                                            <option value="none" {{ old('auto_recording',$editdata->auto_recording) == 'none'? 'selected' : ''}} >@lang('zoom::lang.none')</option>
                                            <option value="local" {{ old('auto_recording',$editdata->auto_recording) == 'local'? 'selected' : ''}} >@lang('zoom::lang.local')</option>
                                            <option value="cloud" {{ old('auto_recording',$editdata->auto_recording) == 'cloud'? 'selected' : ''}} >@lang('zoom::lang.cloud')</option>
                                        @else
                                            <option value="none" {{ old('auto_recording',$default_settings->auto_recording) == 'none'? 'selected' : ''}} >@lang('zoom::lang.none')</option>
                                            <option value="local" {{ old('auto_recording',$default_settings->auto_recording) == 'local'? 'selected' : ''}} >@lang('zoom::lang.local')</option>
                                            <option value="cloud" {{ old('auto_recording',$default_settings->auto_recording) == 'cloud'? 'selected' : ''}} >@lang('zoom::lang.cloud')</option>
                                        @endif
                                    </select>
                    ...
                    <div class="row mt-30 default-settings">
                        <div class="col-lg-12 row">
                            <p class="text-uppercase fw-500 mb-10 col-lg-6" style="width: 130px;">@lang('zoom::lang.audio_options')</p>
                            <div class="col-lg-6">
                                <select class="w-100 bb niceSelect form-control {{ @$errors->has('audio') ? ' is-invalid' : '' }}" name="audio">
                                    <option data-display="@lang('zoom::lang.select') @lang('zoom::lang.package') *" value="">@lang('zoom::lang.select') @lang('zoom::lang.package') *</option>
                                    @if (isset($editdata))
                                        <option value="both" {{ old('audio',$editdata->audio) == 'both' ? 'selected' : ''}} >@lang('zoom::lang.both')</option>
                                        <option value="telephony"  {{ old('audio',$editdata->audio) == 'telephony'? 'selected' : ''}}>@lang('zoom::lang.telephony')</option>
                                        <option value="voip"  {{ old('audio',$editdata->audio) == 'voip'? 'selected' : ''}} >@lang('zoom::lang.voip')</option>
                                    @else
                                        <option value="both" {{ old('audio',$default_settings->audio) == 'both' ? 'selected' : ''}} >@lang('zoom::lang.both')</option>
                                        <option value="telephony"  {{ old('audio',$default_settings->audio) == 'telephony'? 'selected' : ''}}>@lang('zoom::lang.telephony')</option>
                                        <option value="voip"  {{ old('audio',$default_settings->audio) == 'voip'? 'selected' : ''}} >@lang('zoom::lang.voip')</option>
                                    @endif
                    ...
                    <div class="row mt-30 default-settings">
                        <div class="col-lg-12 row">
                            <p class="text-uppercase fw-500 mb-10 col-lg-6" style="width: 130px;">@lang('zoom::lang.meeting_approval')</p>
                            <div class="col-lg-6">
                                <select class="w-100 bb niceSelect form-control {{ @$errors->has('approval_type') ? ' is-invalid' : '' }}" name="approval_type">
                                    @if (isset($editdata))
                                        <option data-display="@lang('zoom::lang.select') @lang('zoom::lang.package') *" value="">@lang('zoom::lang.select') @lang('zoom::lang.package') *</option>
                                        <option value="0" {{ old('approval_type',$editdata->approval_type) == 0? 'selected' : ''}} >@lang('zoom::lang.automatically')</option>
                                        <option value="1" {{ old('approval_type',$editdata->approval_type) == 1? 'selected' : ''}} >@lang('zoom::lang.manually') @lang('zoom::lang.approve')</option>
                                        <option value="2" {{ old('approval_type',$editdata->approval_type) == 2? 'selected' : ''}} >@lang('zoom::lang.no') @lang('zoom::lang.registration') @lang('zoom::lang.required')</option>
                                    @else
                                        <option data-display="@lang('zoom::lang.select') @lang('zoom::lang.package') *" value="">@lang('zoom::lang.select') @lang('zoom::lang.package') *</option>
                                        <option value="0" {{ old('approval_type',$default_settings->approval_type) == 0? 'selected' : ''}} >@lang('zoom::lang.automatically')</option>
                                        <option value="1" {{ old('approval_type',$default_settings->approval_type) == 1? 'selected' : ''}} >@lang('zoom::lang.manually') @lang('zoom::lang.approve')</option>
                                        <option value="2" {{ old('approval_type',$default_settings->approval_type) == 2? 'selected' : ''}} >@lang('zoom::lang.no') @lang('zoom::lang.registration') @lang('zoom::lang.required')</option>
                                    @endif
